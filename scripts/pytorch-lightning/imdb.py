...
from pl_modules import HuggingfaceDatasetWrapper, PlAutoModelForSequenceClassification, HuggingfaceTrainer, HugginfaceWrapper
...
def main(hparams):
    ...
    dataset = HuggingfaceDatasetWrapper(data, text_column='text', target_column='label', tokenizer=tokenizer)
